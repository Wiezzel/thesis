\begin{tikzpicture}[x=1pt,y=-1pt,scale=36]
	...
	\node [leaf] (yes1) [below=35pt of outlook] {\adjbl{yes}};
	...
	\node [leaf] (yes2) [left=20 pt of dummy1] {\adjbl{yes}};
	\node [leaf] (yes3) [left=20 pt of dummy2] {\adjbl{yes}};
	\node [leaf] (no1) [right=20pt of dummy1] {\adjbl{no}};
	\node [leaf] (no2) [right=20pt of dummy2] {\adjbl{no}};
