...
The results of classifiers' evaluation may be described as promising, but still far from perfect. The unique character of the target variable makes them rather incomparable with other results presented in related work. Apart from this, an error rate reaching over 30\% of the target variable's range definitely calls for some more improvement.
...
\subsection{Cost-agnostic evaluation}
\label{sec:cost-agnostic}
...
\subsection{Advanced identification of bugs}
\label{sec:advanced identification}
