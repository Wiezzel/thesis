...
\label{sec:set-up}
Repositories containing the test data were cloned from \textsc{GitHub} into local directories. Further, the test interface of \ca was used, providing the paths to the local clones as arguments. As described in Section \ref{sec:test_interface}, \ca loaded the contents from the input directories and outputted unprocessed data sets in ARFF format. Time of the extraction was measured using the system clock.
...
\end{enumerate}
Full code listing of the script can be found in \nameref{cha:experimental_script}.
...
\chapter*{Appendix: Experimental script}
\label{cha:experimental_script}
\addcontentsline{toc}{chapter}{\nameref{cha:experimental_script}}

\lstinputlisting[language=R,basicstyle=\ttfamily\small,commentstyle=\ttfamily\small]{experimental_script.r}
