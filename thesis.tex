...
This section gives a broad overview of the architecture of \ca by describing briefly every package and class. However, the following description is not intended to serve as a technical documentation. For more details, please visit the JavaDoc page: \url{http://wiezzel.github.io/changeanalyzer/}.
...
\subsection{Root package}
\label{sec:root}
Full package name: \texttt{pl.edu.mimuw.changeanalyzer}

\subsection{Extraction package}
\label{sec:extraction}
Full package name: \texttt{pl.edu.mimuw.changeanalyzer.extraction}

\subsection{Models package}
\label{sec:models}
Full package name: \texttt{pl.edu.mimuw.changeanalyzer.models}

\subsection{Attributes package}
\label{sec:attributes}
Full package name: \texttt{pl.edu.mimuw.changeanalyzer.models.attributes}

\subsection{Measures package}
\label{sec:measures}
Full package name: \texttt{pl.edu.mimuw.changeanalyzer.models.measures}

\subsection{Standard implementations package}
\label{sec:standard}
Full package name: \texttt{pl.edu.mimuw.changeanalyzer.models.standard}

\subsection{Utilities package}
\label{sec:utilities}
Full package name: \texttt{pl.edu.mimuw.changeanalyzer.utils}

\subsection{Exceptions package}
\label{sec:exceptions}
Full package name: \texttt{pl.edu.mimuw.changeanalyzer.exceptions}
